class Argument(object):
	def __init__(self):
		...
		# Checkpointing
		self.restore = False
		self.save_dir = "./save_model/moving_quarter" # directory in which training state and model should be saved
		# self.save_rate = 1000 # save model once every time this many episodes are completed
		self.load_dir = "./save_model/moving_quarter" # directory in which training state and model are loaded